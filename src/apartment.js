...
const entranceWayMaterial = new THREE.MeshPhongMaterial({
  color: "black",
  transparent: true,
  opacity: 0.1,
});
...
// Dog pen materials
const penWallMaterial = new THREE.MeshPhongMaterial({
  color: "black",
  transparent: true,
  opacity: 0.5,
  side: THREE.DoubleSide,
...
const paintingMaterialsGreen = new THREE.MeshPhongMaterial({
  color: "#043927",
});
...
kitchenBottomWall.position.set(2.5, -1.5, -0.2);
...
kitchenPillarWall.position.set(-1.5, 0, -0.2);
...
// draggableObjects.add( woodBlock );
...
draggableObjects.add(indoorDogPen);
// let indoorDogPenBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
// indoorDogPenBB.setFromObject(indoorDogPen);
...
// draggableObjects.add( blackBlueDesk );
...
// draggableObjects.add( bookshelf );
...
// draggableObjects.add( flatScreenTV );
...
// draggableObjects.add( metalTable );
...
// draggableObjects.add( leatherChair );
...
draggableObjects.add(officeSamuraiPainting);
// let officeSamuraiPaintingBB = new THREE.Box3(
//   new THREE.Vector3(),
//   new THREE.Vector3()
// );
// officeSamuraiPaintingBB.setFromObject(officeSamuraiPainting);
...
draggableObjects.add(officeRoshaschPainting);
// let officeRoshaschPaintingBB = new THREE.Box3(
//   new THREE.Vector3(),
//   new THREE.Vector3()
// );
// officeRoshaschPaintingBB.setFromObject(officeRoshaschPainting);
...
draggableObjects.add(officeJesterPainting);
// let officeJesterPaintingBB = new THREE.Box3(
//   new THREE.Vector3(),
//   new THREE.Vector3()
// );
// officeJesterPaintingBB.setFromObject(officeJesterPainting);
...
entranceSamuraiPainting.position.set(-3.5, 0.7, 9.9);
entranceSamuraiPainting.name = "entranceSamuraiPainting";
draggableObjects.add(entranceSamuraiPainting);
// let entranceSamuraiPaintingBB = new THREE.Box3(
//   new THREE.Vector3(),
//   new THREE.Vector3()
// );
// entranceSamuraiPaintingBB.setFromObject(entranceSamuraiPainting);
...
draggableObjects.add(livingRoomSamuraiPainting);
// let livingRoomSamuraiPaintingBB = new THREE.Box3(
//   new THREE.Vector3(),
//   new THREE.Vector3()
// );
// livingRoomSamuraiPaintingBB.setFromObject(livingRoomSamuraiPainting);
...
//         // // draggableObjects.add( fox );
//         // draggableObjects.add( cyber.scene );
...
gltfLoader.load(
  ...
  (fox) => {
    ...
    fox.scene.name = "fox";
    // draggableObjects.add( fox );
    draggableObjects.add(fox.scene);
  },
  (progress) => {
...
gltfLoader.load(
  ...
  (furnitures) => {
    ...
    // let bedBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    ...
    bookshelf.position.set(-1.5, -2.5, 0.3);
    bookshelf.rotation.set(0, Math.PI * 2, 0);
    bookshelf.name = "bookshelf";
    scene.add(bookshelf);
    draggableObjects.add(bookshelf);
    // let bookshelfBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    // bookshelfBB.setFromObject(bookshelf);
    ...
    draggableObjects.add(officeTable);
    // let officeTableBB = new THREE.Box3(
    //   new THREE.Vector3(),
    //   new THREE.Vector3()
    // );
    // officeTableBB.setFromObject(officeTable);
    ...
    chair.name = "chair";
    scene.add(chair);
    draggableObjects.add(chair);
    // let chairBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    // chairBB.setFromObject(chair);
    ...
    fridge.name = "fridge";
    // draggableObjects.add( fridge );
    scene.add(fridge);
    // let fridgeBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    // fridgeBB.setFromObject(fridge);
    ...
    lamp.name = "lamp";
    scene.add(lamp);
    draggableObjects.add(lamp);
    // let lampBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    // lampBB.setFromObject(lamp);
    ...
    piano.name = "piano";
    scene.add(piano);
    draggableObjects.add(piano);
    // let pianoBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    // pianoBB.setFromObject(piano);
    ...
    scene.add(dresser);
    draggableObjects.add(dresser);
    // let dresserBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    // dresserBB.setFromObject(dresser);
    ...
    sofa.name = "sofa";
    scene.add(sofa);
    draggableObjects.add(sofa);
    // let sofaBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    ...
    tvSet.name = "tvSet";
    scene.add(tvSet);
    draggableObjects.add(tvSet);
    // let tvSetBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    // tvSetBB.setFromObject(tvSet);
    ...
    // draggableObjects.add( counter );
    scene.add(counter);
    // let counterBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    // counterBB.setFromObject(counter);
    ...
    desk.name = "desk";
    scene.add(desk);
    draggableObjects.add(desk);
    // let deskBB = new THREE.Box3(new THREE.Vector3(), new THREE.Vector3());
    // deskBB.setFromObject(desk);
...
gltfLoader.load(
  ...
  (bathroom_modern) => {
    bathroom_modern.scene.scale.set(0.85, 0.6, 0.3);
